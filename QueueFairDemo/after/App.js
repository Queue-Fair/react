...
const QueueFairConfig = {
  ...
  queue: 'QUEUE_SYSTEM_NAME_FROM_PORTAL', //Required - The System Name of the queue you wish to use.
  variant: 'react', //Optional - variant name for the queue page variant you wish to display.
...
const QueueFairListener = {
  ...
  // QueueFairWebView does not require the listeners to be grouped
